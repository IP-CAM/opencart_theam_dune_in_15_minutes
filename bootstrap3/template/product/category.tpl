...
<div class="col-md-<?php echo $this::getColumnWidth($column_left, $column_right); ?>">
  <div id="content"><?php echo $content_top; ?>
    ...
    <div class="page-header"><h1><?php echo $heading_title; ?></h1></div>
      ...
      <div class="category-info row navbar">
        <?php if ($thumb) { ?>
        <div class="image col-md-4"><img class="img-responsive" src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></div>
        <?php } ?>
        <?php if ($description) { ?>
        <?php $class = $thumb ? ' col-md-8' : ' col-md-12'; ?>
        <div class="description<?php echo $class; ?>"><?php echo $description; ?></div>
        <?php } ?>
      </div>
      <?php } ?>
      <?php if ($categories) { ?>
      <div class="category-list">
        ...
        <div class="row">
          <?php $j = $i + ceil(count($categories)); ?>
          <?php for (; $i < $j; $i++) { ?>
          <?php if (isset($categories[$i])) { ?>
          <div class="col-md-3">
            <div class="thumbnail text-center">
              <div class="image">
                <?php if (!empty($categories[$i]['image'])) { ?>
                <a href="<?php echo $categories[$i]['href']; ?>"><img class="img-responsive" src="<?php echo $categories[$i]['image']; ?>" title="<?php echo $categories[$i]['name']; ?>" alt="<?php echo $categories[$i]['name']; ?>"/></a>
                <?php } ?>
              </div>
              <h2 class="h5">
                <a title="<?php echo $categories[$i]['name']; ?>" href="<?php echo $categories[$i]['href']; ?>"><?php echo $categories[$i]['name']; ?></a>
              </h2>
            </div>
          </div>
          <?php } ?>
      ...
      <div class="pagination-wrapper clearfix">
        <div class="pagination pager-bottom pull-right"><?php echo $pagination; ?></div>
      </div>
      <?php } ?>
