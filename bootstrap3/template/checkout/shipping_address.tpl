...
?>
<?php if ($addresses) { ?>
<div class="btn-group panel" data-toggle="buttons">
  <label class="btn btn-default active">
    <input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" autocomplete="off"  checked><?php echo $text_address_existing; ?>
  </label>
  <label class="btn btn-default">
    <input type="radio" name="shipping_address" value="new" id="shipping-address-new" autocomplete="off"><?php echo $text_address_new; ?>
  </label>
</div>
<div id="shipping-existing" class="clearfix" data-toggle="buttons">

  <?php foreach ($addresses as $address) { ?>
  <label id="shipping-address<?php echo $address['address_id']; ?>" for="shipping-address<?php echo $address['address_id']; ?>" class="btn btn-default<?php echo ($address['address_id'] == $address_id) ? ' active' : '';?>">
    <input id="shipping-address<?php echo $address['address_id']; ?>" type="radio" name="address_id" value="<?php echo $address['address_id']; ?>" autocomplete="off"<?php echo ($address['address_id'] == $address_id ? ' checked' : ''); ?>>
...
<?php } ?>
<div id="shipping-new" class="form-horizontal clearfix" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
...
<div class="buttons nav navbar clearfix">
  <div class="right pull-right">
    <button id="button-shipping-address" class="button btn btn-success"><?php echo $button_continue; ?> <span class="glyphicon glyphicon-chevron-down"></span></button>
  </div>
</div>
